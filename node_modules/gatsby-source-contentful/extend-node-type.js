...
const cacheImage = require(`./cache-image`); // By default store the images in `.cache` but allow the user to override
...
const getBase64Image = imageProps => {
  ...
  const requestUrl = `https:${imageProps.baseUrl}?w=20`; // Note: sha1 is unsafe for crypto but okay for this particular case

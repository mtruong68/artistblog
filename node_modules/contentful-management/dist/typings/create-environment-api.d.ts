...
export default function createEnvironmentApi({ http, httpUpload, }: {
     ...
     * ```
     **/
    getEntryFromData(entryData: EntryProp): Entry;
    /**
     ...
     * ```
     */
    getContentTypes(query?: QueryOptions): Promise<import("./common-types").Collection<ContentType, ContentTypeProps>>;
    /**
     ...
     * ```
     */
    getEntry(id: string, query?: QueryOptions): Promise<Entry>;
    /**
     ...
     * ```
     */
    getEntries(query?: QueryOptions): Promise<import("./common-types").Collection<Entry, EntryProp>>;
    /**
     * Creates a Entry
     ...
     *  ```
     */
    createAppInstallation(appDefinitionId: string, data: Omit<AppInstallationProps, 'sys'>): Promise<import("./entities/app-installation").AppInstallation>;
    /**
     * Gets an App Installation
     ...
     *  ```
     */
    getAppInstallations(): Promise<import("./common-types").Collection<import("./entities/app-installation").AppInstallation, AppInstallationProps>>;
    /**
     ...
     * ```
     */
    getEntrySnapshots(entryId: string, query?: QueryOptions): Promise<import("./common-types").Collection<import("./entities/snapshot").Snapshot<Entry>, import("./entities/snapshot").SnapshotProps<Entry>>>;
    /**
     ...
     * ```
     */
    getContentTypeSnapshots(contentTypeId: string, query?: QueryOptions): Promise<import("./common-types").Collection<import("./entities/snapshot").Snapshot<ContentType>, import("./entities/snapshot").SnapshotProps<ContentType>>>;
};

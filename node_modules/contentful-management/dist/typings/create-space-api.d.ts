...
export default function createSpaceApi({ http, httpUpload, }: {
     ...
     * ```
     */
    getEnvironment(id: string): Promise<import("./entities/environment").Environment>;
    /**
     ...
     * ```
     */
    getEnvironments(): Promise<import("./common-types").Collection<import("./entities/environment").Environment, EnvironmentProps>>;
    /**
     ...
     * ```
     */
    createEnvironment(data?: {}): Promise<import("./entities/environment").Environment>;
    /**
     ...
     * ```
     */
    createEnvironmentWithId(id: string, data: Omit<EnvironmentProps, 'sys'>, sourceEnvironmentId?: string | undefined): Promise<import("./entities/environment").Environment>;
    /**
     * Gets a Content Type
     ...
     * ```
     */
    getContentType(id: string): Promise<import("./entities/content-type").ContentType>;
    /**
     ...
     * ```
     */
    createContentType(data: Omit<ContentTypeProps, 'sys'>): Promise<import("./entities/content-type").ContentType>;
    /**
     ...
     * ```
     */
    createContentTypeWithId(id: string, data: Omit<ContentTypeProps, 'sys'>): Promise<import("./entities/content-type").ContentType>;
    /**
     ...
     * ```
     */
    getEntries(query?: QueryOptions): Promise<import("./common-types").Collection<import("./entities/entry").Entry, EntryProp>>;
    /**
     * Creates a Entry
     * @deprecated since version 5.0
     ...
     * ```
     */
    createEntry(contentTypeId: string, data: Omit<EntryProp, 'sys'>): Promise<import("./entities/entry").Entry>;
    /**
     ...
     * ```
     */
    createEntryWithId(contentTypeId: string, id: string, data: Omit<EntryProp, 'sys'>): Promise<import("./entities/entry").Entry>;
    /**
     * Creates a Upload.
     * @deprecated since version 5.0
     ...
     * ```
     */
    createAsset: (data: Omit<AssetProps, 'sys'>) => Promise<import("./entities/asset").Asset>;
    /**
     * Gets an Asset
     * Warning: if you are using the select operator, when saving, any field that was not selected will be removed
     * from your entry in the backend
     ...
     * ```
     */
    createAssetWithId(id: string, data: Omit<AssetProps, 'sys'>): Promise<import("./entities/asset").Asset>;
    /**
     ...
     * ```
     */
    getLocale(id: string): Promise<import("./entities/locale").Locale>;
    /**
     ...
     * ```
     */
    getLocales(): Promise<import("./common-types").Collection<import("./entities/locale").Locale, LocaleProps>>;
    /**
     * Creates a Locale
     * @deprecated since version 5.0
     ...
     * ```
     */
    createLocale(data: Omit<LocaleProps, 'sys'>): Promise<import("./entities/locale").Locale>;
    /**
     * Gets a Webhook
     * @param id - Webhook ID
     ...
     * ```
     */
    getRoles(): Promise<import("./common-types").Collection<import("./entities/role").Role, RoleProps>>;
    /**
     * Creates a Role
     ...
     * ```
     */
    createRole(data: Omit<RoleProps, 'sys'>): Promise<import("./entities/role").Role>;
    /**
     ...
     * ```
     */
    createRoleWithId(id: string, data: Omit<RoleProps, 'sys'>): Promise<import("./entities/role").Role>;
    /**
     * Gets a User
     * @param id - User ID
     ...
     * ```
     */
    getSpaceMemberships(query?: QueryOptions): Promise<import("./common-types").Collection<import("./entities/space-membership").SpaceMembership, SpaceMembershipProps>>;
    /**
     ...
     * ```
     */
    createSpaceMembership(data: Omit<SpaceMembershipProps, 'sys'>): Promise<import("./entities/space-membership").SpaceMembership>;
    /**
     ...
     * ```
     */
    createSpaceMembershipWithId(id: string, data: Omit<SpaceMembershipProps, 'sys'>): Promise<import("./entities/space-membership").SpaceMembership>;
    /**
   ...
   */
     ...
     * ```
     */
    getPreviewApiKeys(): Promise<import("./common-types").Collection<import("./entities/preview-api-key").PreviewApiKey, import("./entities/preview-api-key").PreviewApiKeyProps>>;
    /**
     ...
     * ```
     */
    getPreviewApiKey(id: string): Promise<import("./entities/preview-api-key").PreviewApiKey>;
    /**
     * Creates a Api Key
     ...
     * ```
     */
    getEntrySnapshots(entryId: string, query?: QueryOptions): Promise<import("./common-types").Collection<import("./entities/snapshot").Snapshot<unknown>, import("./entities/snapshot").SnapshotProps<unknown>>>;
    /**
     ...
     * ```
     */
    getContentTypeSnapshots(contentTypeId: string, query?: QueryOptions): Promise<import("./common-types").Collection<import("./entities/snapshot").Snapshot<unknown>, import("./entities/snapshot").SnapshotProps<unknown>>>;
    /**
     ...
     * ```
     */
    getEnvironmentAlias(id: string): Promise<import("./entities/environment-alias").EnvironmentAlias>;
    /**

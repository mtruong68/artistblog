 ...
 */
export declare function wrapLocale(http: AxiosInstance, data: LocaleProps): Locale;
/**
 * @private
 */
export declare const wrapLocaleCollection: (http: AxiosInstance, data: CollectionProp<LocaleProps>) => import("../common-types").Collection<Locale, LocaleProps>;

...
var wrapCollection = function wrapCollection(fn) {
  return function (http, data) {
    var collectionData = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(data)); // @ts-ignore
...
function createClient(params) {
  ...
  var api = Object(_create_contentful_api__WEBPACK_IMPORTED_MODULE_0__["default"])({
    http: http
  });
  return api;
}
...
function createCMAHttpClient(params) {
  ...
  "contentful-management.js/".concat("5.27.1"), params.application, params.integration, params.feature);
  var requiredHeaders = {
...
function createEnvironmentApi(_ref) {
  ...
  var _entities$appInstalla = _entities__WEBPACK_IMPORTED_MODULE_3__["default"].appInstallation,
  ...
  return {
    ...
    getEntrySnapshots: function getEntrySnapshots(entryId) {
      var query = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      return http.get("entries/".concat(entryId, "/snapshots"), Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["createRequestConfig"])({
        query: query
      })).then(function (response) {
    ...
    getContentTypeSnapshots: function getContentTypeSnapshots(contentTypeId) {
      var query = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      return http.get("content_types/".concat(contentTypeId, "/snapshots"), Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["createRequestConfig"])({
        query: query
      })).then(function (response) {
        return wrapSnapshotCollection(http, response.data);
      }, _error_handler__WEBPACK_IMPORTED_MODULE_2__["default"]);
...
function createOrganizationApi(_ref) {
  var http = _ref.http;
  var _entities$appDefiniti = _entities__WEBPACK_IMPORTED_MODULE_3__["default"].appDefinition,
  ...
  var _entities$organizatio = _entities__WEBPACK_IMPORTED_MODULE_3__["default"].organizationMembership,
  ...
  var _entities$teamMembers = _entities__WEBPACK_IMPORTED_MODULE_3__["default"].teamMembership,
  ...
  var _entities$teamSpaceMe = _entities__WEBPACK_IMPORTED_MODULE_3__["default"].teamSpaceMembership,
  ...
  var _entities$team = _entities__WEBPACK_IMPORTED_MODULE_3__["default"].team,
  ...
  var wrapOrganizationInvitation = _entities__WEBPACK_IMPORTED_MODULE_3__["default"].organizationInvitation.wrapOrganizationInvitation;
  var headers = {
  ...
  return {
    ...
    createTeam: function createTeam(data) {
      return http.post('teams', data).then(function (response) {
        return wrapTeam(http, response.data);
      }, _error_handler__WEBPACK_IMPORTED_MODULE_2__["default"]);
    },
    ...
    getTeam: function getTeam(teamId) {
      return http.get('teams/' + teamId).then(function (response) {
        return wrapTeam(http, response.data);
      }, _error_handler__WEBPACK_IMPORTED_MODULE_2__["default"]);
    },
    ...
    getTeams: function getTeams() {
      ...
      return http.get('teams', Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["createRequestConfig"])({
        ...
        return wrapTeamCollection(http, response.data);
      }, _error_handler__WEBPACK_IMPORTED_MODULE_2__["default"]);
    },
    ...
    createTeamMembership: function createTeamMembership(teamId, data) {
      return http.post('teams/' + teamId + '/team_memberships', data).then(function (response) {
    ...
    getTeamMembership: function getTeamMembership(teamId, teamMembershipId) {
      return http.get('teams/' + teamId + '/team_memberships/' + teamMembershipId).then(function (response) {
        return wrapTeamMembership(http, response.data);
      }, _error_handler__WEBPACK_IMPORTED_MODULE_2__["default"]);
    },
    ...
    getTeamMemberships: function getTeamMemberships() {
      ...
      var query = lodash_get__WEBPACK_IMPORTED_MODULE_0___default()(opts, 'query', {});
      ...
      if (opts.teamId) {
        return http.get('teams/' + opts.teamId + '/team_memberships', Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["createRequestConfig"])({
          ...
          return wrapTeamMembershipCollection(http, response.data);
        }, _error_handler__WEBPACK_IMPORTED_MODULE_2__["default"]);
      }
    ...
    getOrganizationInvitation: function getOrganizationInvitation(invitationId) {
      return http.get('invitations/' + invitationId, {
        ...
        return wrapOrganizationInvitation(http, response.data);
      }, _error_handler__WEBPACK_IMPORTED_MODULE_2__["default"]);
    },
...
function createSpaceApi(_ref) {
  ...
  var _entities$user = _entities__WEBPACK_IMPORTED_MODULE_3__["default"].user,
      wrapUser = _entities$user.wrapUser,
      wrapUserCollection = _entities$user.wrapUserCollection;
  var _entities$spaceMember = _entities__WEBPACK_IMPORTED_MODULE_3__["default"].spaceMember,
  ...
  var _entities$spaceMember2 = _entities__WEBPACK_IMPORTED_MODULE_3__["default"].spaceMembership,
...
var wrapApiKeyCollection = Object(_common_utils__WEBPACK_IMPORTED_MODULE_4__["wrapCollection"])(wrapApiKey);
...
var entityPath = 'app_definitions';
...
function wrapAppDefinition(http, data) {
  var appDefinition = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(data));
...
var wrapAppDefinitionCollection = Object(_common_utils__WEBPACK_IMPORTED_MODULE_4__["wrapCollection"])(wrapAppDefinition);
...
function createAppInstallationApi(http) {
  return {
    update: function update() {
      ...
      var data = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_1___default()(raw);
      delete data.sys;
...
function wrapAppInstallation(http, data) {
  var appInstallation = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["toPlainObject"])(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_1___default()(data));
  var appInstallationWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_3__["default"])(appInstallation, createAppInstallationApi(http));
...
var wrapAppInstallationCollection = Object(_common_utils__WEBPACK_IMPORTED_MODULE_5__["wrapCollection"])(wrapAppInstallation);
...
var wrapAssetCollection = Object(_common_utils__WEBPACK_IMPORTED_MODULE_4__["wrapCollection"])(wrapAsset);
  ...
  return {
    ...
    getEditorInterface: function getEditorInterface() {
      return http.get('content_types/' + this.sys.id + '/editor_interface').then(function (response) {
        return Object(_editor_interface__WEBPACK_IMPORTED_MODULE_5__["wrapEditorInterface"])(http, response.data);
      }, _error_handler__WEBPACK_IMPORTED_MODULE_6__["default"]);
    },
    getSnapshots: function getSnapshots() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      return http.get("content_types/".concat(this.sys.id, "/snapshots"), Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["createRequestConfig"])({
        query: query
      })).then(function (response) {
        return Object(_snapshot__WEBPACK_IMPORTED_MODULE_7__["wrapSnapshotCollection"])(http, response.data);
      }, _error_handler__WEBPACK_IMPORTED_MODULE_6__["default"]);
    },
    getSnapshot: function getSnapshot(snapshotId) {
      return http.get("content_types/".concat(this.sys.id, "/snapshots/").concat(snapshotId)).then(function (response) {
        return Object(_snapshot__WEBPACK_IMPORTED_MODULE_7__["wrapSnapshot"])(http, response.data);
      }, _error_handler__WEBPACK_IMPORTED_MODULE_6__["default"]);
    },
    ...
    omitAndDeleteField: function omitAndDeleteField(id) {
      ...
      })["catch"](_error_handler__WEBPACK_IMPORTED_MODULE_6__["default"]);
    }
  };
}
/**
...
function createEntryApi(http) {
  return {
    ...
    getSnapshots: function getSnapshots() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      return http.get("entries/".concat(this.sys.id, "/snapshots"), Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["createRequestConfig"])({
        query: query
      })).then(function (response) {
...
var wrapEnvironmentAliasCollection = Object(_common_utils__WEBPACK_IMPORTED_MODULE_4__["wrapCollection"])(wrapEnvironmentAlias);
...
function wrapOrganizationInvitation(http, data) {
  var invitation = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(data));
...
function wrapOrganizationMembership(http, data) {
  var organizationMembership = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(data));
  var organizationMembershipWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(organizationMembership, createOrganizationMembershipApi(http));
...
var wrapOrganizationMembershipCollection = Object(_common_utils__WEBPACK_IMPORTED_MODULE_5__["wrapCollection"])(wrapOrganizationMembership);
...
function wrapOrganization(http, data) {
  var org = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(data));
...
function wrapPersonalAccessToken(http, data) {
  ...
  var personalAccessTokenWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(personalAccessToken, createPersonalAccessToken(http));
...
var wrapPersonalAccessTokenCollection = Object(_common_utils__WEBPACK_IMPORTED_MODULE_4__["wrapCollection"])(wrapPersonalAccessToken);
...
function wrapSpaceMember(http, data) {
  var spaceMember = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(data));
...
function wrapTeamMembership(http, data) {
  var teamMembership = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(data));
...
var wrapTeamMembershipCollection = Object(_common_utils__WEBPACK_IMPORTED_MODULE_4__["wrapCollection"])(wrapTeamMembership);
...
function wrapTeamSpaceMembership(http, data) {
  var teamSpaceMembership = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(data));
...
var wrapTeamSpaceMembershipCollection = Object(_common_utils__WEBPACK_IMPORTED_MODULE_5__["wrapCollection"])(wrapTeamSpaceMembership);
...
function wrapTeam(http, data) {
  var team = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(data));
...
function wrapUsage(http, data) {
  var usage = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(data));
...
function wrapUser(http, data) {
  var user = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["toPlainObject"])(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_1___default()(data));
...
var wrapWebhookCollection = Object(_common_utils__WEBPACK_IMPORTED_MODULE_5__["wrapCollection"])(wrapWebhook);
...
/***/ 0:
/*!**********************************************************************************************************!*\
  !*** multi core-js/fn/promise core-js/fn/object/assign core-js/fn/array/from ./contentful-management.ts ***!
  \**********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

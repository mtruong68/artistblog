...
function createCMAHttpClient(params) {
  ...
  `contentful-management.js/${"5.27.1"}`, params.application, params.integration, params.feature);
...
function createEnvironmentApi({
  ...
  const wrapEnvironment = _entities__WEBPACK_IMPORTED_MODULE_3__["default"].environment.wrapEnvironment;
  ...
  const _entities$appInstalla = _entities__WEBPACK_IMPORTED_MODULE_3__["default"].appInstallation,
  ...
  return {
    ...
    createAppInstallation(appDefinitionId, data) {
      return http.put('app_installations/' + appDefinitionId, data).then(response => wrapAppInstallation(http, response.data), _error_handler__WEBPACK_IMPORTED_MODULE_2__["default"]);
    },
    ...
    getAppInstallation(id) {
      return http.get('app_installations/' + id).then(response => wrapAppInstallation(http, response.data), _error_handler__WEBPACK_IMPORTED_MODULE_2__["default"]);
    },
     ...
     */
    getAppInstallations() {
      return http.get('app_installations').then(response => wrapAppInstallationCollection(http, response.data), _error_handler__WEBPACK_IMPORTED_MODULE_2__["default"]);
    },
